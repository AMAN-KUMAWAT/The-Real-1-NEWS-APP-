...
class SportsFetch {
  static Future<SportsData> fetchNews() async {
    // ignore: unused_local_variable
    Response response = await get(Uri.parse(
        "https://newsapi.org/v2/top-headlines?sources=bbc-sport&apiKey=c9035e4732e44b3abb275b19b414d6b9"));
    ...
    return SportsData.fromApiToApp(myArticle);
  }
}
